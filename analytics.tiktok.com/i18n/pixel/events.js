...
window[window["TiktokAnalyticsObject"]]._vids = '74172070,74813232';
window[window["TiktokAnalyticsObject"]]._cc = 'BR';
window[window.TiktokAnalyticsObject]._li || (window[window.TiktokAnalyticsObject]._li = {}), window[window.TiktokAnalyticsObject]._li["C7IPDDVB3D4VREVL5PFG"] = "c7e02b50-cfef-11f0-b0e5-02001711da9f";
window[window["TiktokAnalyticsObject"]]._cde = 390;;
if (!window[window["TiktokAnalyticsObject"]]._server_unique_id) window[window["TiktokAnalyticsObject"]]._server_unique_id = 'c7e059dd-cfef-11f0-b0e5-02001711da9f';
...
! function(e, n, i, d, o, t) {
    var u, l, a = c()._static_map || [{
        ...
        e = (c()._static_map = a, l = "https://analytics.tiktok.com/i18n/pixel/static/", null == (e = u = {
            "info": {
                "pixelCode": "C7IPDDVB3D4VREVL5PFG",
                "name": "Pixel Linda Sedução - TikTok",
                "status": 0,
                "setupMode": 1,
                "partner": "",
                "advertiserID": "7054204712303853569",
                "is_onsite": false,
